...
<section class="home">
   ...
   <div class="swiper home-slider">
      ...
      <div class="swiper-wrapper">
         ...
         <section class="swiper-slide slide" style="background: url(images/cat_cover_3.jpg)  no-repeat;">
            <div class="content">
...
<section class="subjects">
   ...
   <div class="box-container">
      ...
      <div class="box">
         ...
         <a href="teachers.php"><h3>Medical inquiry</h3></a>
         <p>Medical related queries and vet schedules.</p>
      </div>

      <div class="box">
         <img src="images/food_icon_1.png" alt="">
         <a href="food.php"><h3>Pet food informations</h3></a>
...
<section class="reviews" id="rev">
   ...
   <div class="box-container">
      <?php
         $select_reviews = $conn->prepare("SELECT * FROM `reviews` limit 4");
...
<div class="more-btn box-container">
      <a href="review.php" class="inline-option-btn" style="text-align: center;" >view more</a>
   </div>
</section>
...
<section class="courses">
   ...
   <div class="box-container">
      ...
      <?php
         $select_courses = $conn->prepare("SELECT * FROM `playlist` WHERE status = ? ORDER BY date DESC limit 4");
