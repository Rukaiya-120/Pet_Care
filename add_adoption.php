...
<section class="account-form">
   ...
   <form action="" method="post" enctype="multipart/form-data">
      ...
      <textarea name="description" class="box" placeholder="enter adoption description" maxlength="1000" cols="30" rows="10">
         
      </textarea>
      <p class="placeholder">Image: <span>*</span></p>
      <input type="file" name="image" accept="image/*" required class="box">
      <input type="submit" value="submit adoption" name="submit" class="btn">
      <a href="adoption.php#rev" class="option-btn">go back</a>
   </form>
