...
<section class="quick-select">
   ...
   <div class="box-container">
      ...
      <div class="box tutor">
         ...
         <a href="adoption.php#shelter" class="inline-btn">Sheltered Animal</a>
      </div>

      <div class="box tutor">
         <h3 class="title">Help for rescued paws !!!</h3>
         <p>The donations are directly used for the rescued animals.</p>
         <a href="donate.php" class="inline-btn">Donate</a>
      </div>

      <div class="box tutor">
         <h3 class="title">More information</h3>
         <p>Contact us to know more.Feel free to contact.</p>
 ...
 <section class="about">
   ...
   <div class="row">
      ...
      <div class="content">
         ...
         <a href="add_adoption.php" class="inline-btn">Submit Adoption</a>
      </div>
   ...
   <div class="box-container">
      ...
      <div class="box">
         <p style="font-size: 1.5rem;"> <?= $fetch_adoption['description']; ?></p>
            <img src="uploaded_files/<?= $fetch_adoption['image']; ?>" class = "thumb" alt="">
         <div class="tutor">
...
<?php include 'components/shelter.php'; ?>
